...
<html>
 <head>
   ...
   <style type="text/css">
     ...
     /* Logo */
     #logo { padding:0px; width:auto; float:left;}
     ...
     .feature-inner { margin:auto;padding:10px;width:970px;background:#a32a29; }
     .feature-inner h1 {margin-left: 10px;color:pink;font-size:32px;}

     /* Menu */
     #top-nav { margin-top:60px; padding:0px 0 0; height:37px; float:right;}
     #top-nav ul { list-style:none; padding:0; height:37px; float:left;}
     #top-nav ul li { margin:0; padding:0 0 0 8px; float:right;}
     #top-nav ul li a { display:block; margin:0; padding:8px 20px; color:#a32a29; text-decoration:none;}
     ...
     #footerblurb-inner { margin:0 auto; width:970px; padding:10px;background:#989898;border-bottom-right-radius:15px;border-bottom-left-radius:15px;}
